...
public class DBAdapter extends SQLiteOpenHelper {
    ...
    //facult crud
    public void addFaculty(facultBean facultBean) {
        ...
        String query = "INSERT INTO faculty_table (faculty_firstname,faculty_Lastname,faculty_mobilenumber,faculty_address,faculty_username,faculty_password) values ('" +
                facultBean.getFaculty_firstname() + "', '" +
                facultBean.getFaculty_lastname() + "', '" +
                facultBean.getFaculty_mobilenumber() + "', '" +
                facultBean.getFaculty_address() + "', '" +
                facultBean.getFaculty_username() + "', '" +
                facultBean.getFaculty_password() + "')";
        Log.d("query", query);
        db.execSQL(query);
        db.close();
    }

    public facultBean validateFaculty(String userName, String password) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        if (cursor.moveToFirst()) {
            ...
            facultBean facultBean = new facultBean();
            facultBean.setFaculty_id(Integer.parseInt(cursor.getString(0)));
            facultBean.setFaculty_firstname(cursor.getString(1));
            facultBean.setFaculty_lastname(cursor.getString(2));
            facultBean.setFaculty_mobilenumber(cursor.getString(3));
            facultBean.setFaculty_address(cursor.getString(4));
            facultBean.setFaculty_username(cursor.getString(5));
            facultBean.setFaculty_password(cursor.getString(6));
            return facultBean;
        }
        return null;
    }

    public ArrayList<facultBean> getAllFaculty() {
        Log.d("in get all", "in get all");
        ArrayList<facultBean> list = new ArrayList<facultBean>();
